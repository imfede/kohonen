...
class Kohonen implements Serializable {

    static int inputDimension = 3;
    static int numberOfNeurons = 200;
    static int netDimension = 2;
    static int numberOfRows  = 20; // assert (nON % nOR == 0)
